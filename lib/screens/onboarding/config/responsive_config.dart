...
class OnboardingResponsiveConfig {
  ...
  double get titleFontSize => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minTitleFontSize,
    maxTitleFontSize,
  );
  double get bodyFontSize => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minBodyFontSize,
    maxBodyFontSize,
  );
  double get cardTitleFontSize => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minCardTitleFontSize,
    maxCardTitleFontSize,
  );

  // Image sizes - smoothly adapt
  double get qrCodeSize => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minQrCodeSize,
    maxQrCodeSize,
  );
  double get qrCodeScale => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minQrCodeScale,
    maxQrCodeScale,
  );
  double get butterflySize => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minButterflySize,
    maxButterflySize,
  ...
  double get verticalSpacing => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minVerticalSpacing,
    maxVerticalSpacing,
  );
  double get cardPadding => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minCardPadding,
    maxCardPadding,
  );
  double get topPadding => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minTopPadding,
    maxTopPadding,
  );
  double get bottomSpacing => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minBottomSpacing,
    maxBottomSpacing,
  ...
  double get screen1TitleTop => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minScreen1TitleTop,
    maxScreen1TitleTop,
  );
  double get screen1CardWidth => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minScreen1CardWidth,
    maxScreen1CardWidth,
  );
  double get screen1CardPadding => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minScreen1CardPadding,
    maxScreen1CardPadding,
  );
  double get screen1CardTextSize => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minScreen1CardTextSize,
    maxScreen1CardTextSize,
  );
  double get screen1ButterflySize => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minScreen1ButterflySize,
    maxScreen1ButterflySize,
  );
  double get screen1ButtonBottom => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minScreen1ButtonBottom,
    maxScreen1ButtonBottom,
  );
  ...
  double get screen2TitleTop => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minScreen2TitleTop,
    maxScreen2TitleTop,
  );
  double get screen2PhoneBottomPadding => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minScreen2PhoneBottomPadding,
    maxScreen2PhoneBottomPadding,
  );
  double get screen2PhoneHeightRatio => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minScreen2PhoneHeightRatio,
    maxScreen2PhoneHeightRatio,
  );
  double get screen2CardBottom => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minScreen2CardBottom,
    maxScreen2CardBottom,
  );
  double get screen2CardPadding => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minScreen2CardPadding,
    maxScreen2CardPadding,
  );
  double get screen2CardTextSize => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minScreen2CardTextSize,
    maxScreen2CardTextSize,
  );
  double get screen2ButtonBottom => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minScreen2ButtonBottom,
    maxScreen2ButtonBottom,
  );

  // Screen 3 specific - Getters
  double get screen3TopPadding => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minScreen3TopPadding,
    maxScreen3TopPadding,
  );
  double get screen3QrCodeSize => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minScreen3QrCodeSize,
    maxScreen3QrCodeSize,
  );
  double get screen3TitlePaddingV => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minScreen3TitlePaddingV,
    maxScreen3TitlePaddingV,
  );

  EdgeInsets get cardInsets {
    final horizontal = _interpolate(
      minScreenHeight,
      maxScreenHeight,
      minCardInsetsHorizontal,
      maxCardInsetsHorizontal,
    );
    final vertical = _interpolate(
      minScreenHeight,
      maxScreenHeight,
      minCardInsetsVertical,
      maxCardInsetsVertical,
    );
    return EdgeInsets.symmetric(horizontal: horizontal, vertical: vertical);
  }

  // Screen 4 specific - Getters
  double get screen4TitleFontSize => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minScreen4TitleFontSize,
    maxScreen4TitleFontSize,
  );
  double get screen4CardSpacing => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minScreen4CardSpacing,
    maxScreen4CardSpacing,
  );
  double get screen4CardTextFontSize => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minScreen4CardTextFontSize,
    maxScreen4CardTextFontSize,
  );
  double get screen4CardButterflySize => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minScreen4CardButterflySize,
    maxScreen4CardButterflySize,
  );
  double get screen4BoomTitleFontSize => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minScreen4BoomTitleFontSize,
    maxScreen4BoomTitleFontSize,
  );
  double get screen4BoomDescFontSize => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minScreen4BoomDescFontSize,
    maxScreen4BoomDescFontSize,
  );
  double get screen4BoomPadding => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minScreen4BoomPadding,
    maxScreen4BoomPadding,
  );
  double get screen4BoomTitleSpacing => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minScreen4BoomTitleSpacing,
    maxScreen4BoomTitleSpacing,
  );

  // Screen 5 specific - Getters
  double get screen5TitleFontSize => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minScreen5TitleFontSize,
    maxScreen5TitleFontSize,
  );
  double get screen5TitleTop => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minScreen5TitleTop,
    maxScreen5TitleTop,
  );
  double get screen5PhoneHeightRatio => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minScreen5PhoneHeightRatio,
    maxScreen5PhoneHeightRatio,
  );
  double get screen5PhoneBottomPadding => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minScreen5PhoneBottomPadding,
    maxScreen5PhoneBottomPadding,
  );
  double get screen5BubbleSpacing => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minScreen5BubbleSpacing,
    maxScreen5BubbleSpacing,
  );
  double get screen5BubbleTitleFontSize => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minScreen5BubbleTitleFontSize,
    maxScreen5BubbleTitleFontSize,
  );
  double get screen5BubbleSubtitleFontSize => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minScreen5BubbleSubtitleFontSize,
    maxScreen5BubbleSubtitleFontSize,
  );
  double get screen5BubblesBottom => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minScreen5BubblesBottom,
    maxScreen5BubblesBottom,
  );
  double get screen5BubbleInnerSpacing => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minScreen5BubbleInnerSpacing,
    maxScreen5BubbleInnerSpacing,
  );

  EdgeInsets get screen5BubblePadding {
    final h = _interpolate(
      minScreenHeight,
      maxScreenHeight,
      minScreen5BubblePaddingH,
      maxScreen5BubblePaddingH,
    );
    final v = _interpolate(
      minScreenHeight,
      maxScreenHeight,
      minScreen5BubblePaddingV,
      maxScreen5BubblePaddingV,
    );
    return EdgeInsets.symmetric(horizontal: h, vertical: v);
  }

  // Screen 6 specific - Getters
  double get screen6TitleFontSize => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minScreen6TitleFontSize,
    maxScreen6TitleFontSize,
  );
  double get screen6TitleTop => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minScreen6TitleTop,
    maxScreen6TitleTop,
  );
  double get screen6TitleToBoxSpacing => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minScreen6TitleToBoxSpacing,
    maxScreen6TitleToBoxSpacing,
  );
  double get screen6ButterflyBoxHeight => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minScreen6ButterflyBoxHeight,
    maxScreen6ButterflyBoxHeight,
  );
  double get screen6ButterflyBoxTextSize => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minScreen6ButterflyBoxTextSize,
    maxScreen6ButterflyBoxTextSize,
  );
  double get screen6ButterflyImageSize => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minScreen6ButterflyImageSize,
    maxScreen6ButterflyImageSize,
  );
  double get screen6ButterflyBoxPadding => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minScreen6ButterflyBoxPadding,
    maxScreen6ButterflyBoxPadding,
  );
  double get screen6PhoneScale => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minScreen6PhoneScale,
    maxScreen6PhoneScale,
  );
  double get screen6QrCodeScale => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minScreen6QrCodeScale,
    maxScreen6QrCodeScale,
  );
  double get screen6QrCodeSize => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minScreen6QrCodeSize,
    maxScreen6QrCodeSize,
  );
  double get screen6BottomSpacing => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minScreen6BottomSpacing,
    maxScreen6BottomSpacing,
  );
  // ============================================================
  ...
  // Gossiper Screen 1 - Welcome
  double get gossiper1CardTopRatio => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minGossiper1CardTopRatio,
    maxGossiper1CardTopRatio,
  );

  // Gossiper Screen 2 - Initial Message
  double get gossiper2ModelHeightRatio => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minGossiper2ModelHeightRatio,
    maxGossiper2ModelHeightRatio,
  );
  double get gossiper2CardTopRatio => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minGossiper2CardTopRatio,
    maxGossiper2CardTopRatio,
  );
  double get gossiper2BubblesTopRatio => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minGossiper2BubblesTopRatio,
    maxGossiper2BubblesTopRatio,
  );
  double get gossiper2BubbleWidthRatio => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minGossiper2BubbleWidthRatio,
    maxGossiper2BubbleWidthRatio,
  );
  double get gossiper2BubbleFontSize => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minGossiper2BubbleFontSize,
    maxGossiper2BubbleFontSize,
  );
  double get gossiper2BubblePadding => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minGossiper2BubblePadding,
    maxGossiper2BubblePadding,
  );
  double get gossiper2BubbleSpacing => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minGossiper2BubbleSpacing,
    maxGossiper2BubbleSpacing,
  );
  EdgeInsets get gossiper2CardPadding {
    final h = _interpolate(
      minScreenHeight,
      maxScreenHeight,
      minGossiper2CardPaddingH,
      maxGossiper2CardPaddingH,
    );
    final v = _interpolate(
      minScreenHeight,
      maxScreenHeight,
      minGossiper2CardPaddingV,
      maxGossiper2CardPaddingV,
    );
    return EdgeInsets.symmetric(horizontal: h, vertical: v);
  }

  // Gossiper Screen 3 - Phone Mockup
  double get gossiper3PhoneLeft => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minGossiper3PhoneLeft,
    maxGossiper3PhoneLeft,
  );
  double get gossiper3PhoneTopRatio => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minGossiper3PhoneTopRatio,
    maxGossiper3PhoneTopRatio,
  );
  double get gossiper3PhoneHeightRatio => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minGossiper3PhoneHeightRatio,
    maxGossiper3PhoneHeightRatio,
  );
  double get gossiper3BubblesTopRatio => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minGossiper3BubblesTopRatio,
    maxGossiper3BubblesTopRatio,
  );
  double get gossiper3BubbleWidthRatio => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minGossiper3BubbleWidthRatio,
    maxGossiper3BubbleWidthRatio,
  );
  double get gossiper3BubbleFontSize => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minGossiper3BubbleFontSize,
    maxGossiper3BubbleFontSize,
  );
  double get gossiper3BubblePadding => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minGossiper3BubblePadding,
    maxGossiper3BubblePadding,
  );
  double get gossiper3BubbleSpacing => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minGossiper3BubbleSpacing,
    maxGossiper3BubbleSpacing,
  );
  double get gossiper3ModelRight => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minGossiper3ModelRight,
    maxGossiper3ModelRight,
  );
  double get gossiper3ModelBottom => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minGossiper3ModelBottom,
    maxGossiper3ModelBottom,
  );
  double get gossiper3ModelHeightRatio => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minGossiper3ModelHeightRatio,
    maxGossiper3ModelHeightRatio,
  );
  double get gossiper3DescBottomRatio => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minGossiper3DescBottomRatio,
    maxGossiper3DescBottomRatio,
  );
  double get gossiper3DescWidthRatio => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minGossiper3DescWidthRatio,
    maxGossiper3DescWidthRatio,
  );
  double get gossiper3DescFontSize => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minGossiper3DescFontSize,
    maxGossiper3DescFontSize,
  );
  double get gossiper3DescPadding => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minGossiper3DescPadding,
    maxGossiper3DescPadding,
  );

  // Gossiper Screen 4 - Features
  double get gossiper4TitleFontSize => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minGossiper4TitleFontSize,
    maxGossiper4TitleFontSize,
  );
  double get gossiper4TitleOffset => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minGossiper4TitleOffset,
    maxGossiper4TitleOffset,
  );
  double get gossiper4CardsOffset => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minGossiper4CardsOffset,
    maxGossiper4CardsOffset,
  );
  double get gossiper4CardSpacing => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minGossiper4CardSpacing,
    maxGossiper4CardSpacing,
  );
  double get gossiper4DescPadding => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minGossiper4DescPadding,
    maxGossiper4DescPadding,
  );
  double get gossiper4DescFontSize => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minGossiper4DescFontSize,
    maxGossiper4DescFontSize,
  );
  double get gossiper4DescSpacingTop => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minGossiper4DescSpacingTop,
    maxGossiper4DescSpacingTop,
  );

  // Gossiper Screen 5 - How it Works
  double get gossiper5TitleFontSize => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minGossiper5TitleFontSize,
    maxGossiper5TitleFontSize,
  );
  double get gossiper5ModelLeft => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minGossiper5ModelLeft,
    maxGossiper5ModelLeft,
  );
  double get gossiper5ModelTopRatio => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minGossiper5ModelTopRatio,
    maxGossiper5ModelTopRatio,
  );
  double get gossiper5ModelHeightRatio => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minGossiper5ModelHeightRatio,
    maxGossiper5ModelHeightRatio,
  );
  double get gossiper5TitleTopPadding => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minGossiper5TitleTopPadding,
    maxGossiper5TitleTopPadding,
  );
  double get gossiper5SubtitleFontSize => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minGossiper5SubtitleFontSize,
    maxGossiper5SubtitleFontSize,
  );
  double get gossiper5SubtitleTopPadding => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minGossiper5SubtitleTopPadding,
    maxGossiper5SubtitleTopPadding,
  );
  double get gossiper5QrCodeSize => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minGossiper5QrCodeSize,
    maxGossiper5QrCodeSize,
  );
  double get gossiper5QrCodeLeftPadding => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minGossiper5QrCodeLeftPadding,
    maxGossiper5QrCodeLeftPadding,
  );
  double get gossiper5DescBottomPadding => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minGossiper5DescBottomPadding,
    maxGossiper5DescBottomPadding,
  );
  double get gossiper5DescFontSize => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minGossiper5DescFontSize,
    maxGossiper5DescFontSize,
  );
  double get gossiper5DescPadding => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minGossiper5DescPadding,
    maxGossiper5DescPadding,
  );
  double get gossiper5ButtonBottom => _interpolate(
    minScreenHeight,
    maxScreenHeight,
    minGossiper5ButtonBottom,
    maxGossiper5ButtonBottom,
  );
}
