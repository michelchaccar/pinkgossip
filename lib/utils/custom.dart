...
class API {
  ...
  static String rewardtemplatelist = "${baseUrl}/api/reward-template-list";
  static String salonDetails = "${baseUrl}/api/salon-details";
  static String postCreate = "${baseUrl}/api/salon-review-store";
  static String rewardCreate = "${baseUrl}/api/salon-revard-store";
  static String homepagePost = "${baseUrl}/api/other-user-post";
  static String otherUserRewardPost = "${baseUrl}/api/other-user-reward-post";
  static String myRedeemRewardPost = "${baseUrl}/api/my-redeem-reward";
  static String redeemStorePost = "${baseUrl}/api/redeem-store";
  ...
  static String updateemailvisibility = "${baseUrl}/api/update-email-visiable";
